...
import ControlledComponet from "./components/ControlledComponent";
    ...
    <BrowserRouter>
      <main className="w-screen h-screen bg-slate-400 flex flex-col items-center justify-center">
        ...
        <div className="flex gap-4 py-4">
          ...
          <Link to="/componente-controlado" className="font-bold text-2xl text-blue-700">
        ...
        <Routes>
          ...
          <Route path="/componente-controlado" exact element={<ControlledComponet/>} />
          <Route path="/contador" exact element={<CounterComponet/>} />
